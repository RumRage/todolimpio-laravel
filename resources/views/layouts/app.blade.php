...
<body>
    ...
    <ul class="navbar-nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a class="nav-link {{ Request::is('agendas*') ? 'active' : '' }}" href="{{ route('agendas.index') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('historiales*') ? 'active' : '' }}" href="{{ route('historiales.index') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('cancelados*') ? 'active' : '' }}" href="{{ route('cancelados.index') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('combos*') ? 'active' : '' }}" href="{{ route('combos.index') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('descartables*') ? 'active' : '' }}" href="{{ route('descartables.index') }}">
